...
lexer and the AST. This class will call multiple (static?) classes to help with parsing. The idea is
that I focus a bit on functional programming style for parsing.
