...
const std::vector<Terminal> Lexer::vhdlTerminals = {
    ...
    Terminal(TerminalName::RES_ASSUME, "ASSUME", "\\bASSUME\\b"),
    Terminal(TerminalName::RES_ASSUME_GUARANTEE, "ASSUME_GUARANTEE", "\\bASSUME_GUARANTEE\\b"),
    ...
    Terminal(TerminalName::RES_CONTEXT, "CONTEXT", "\\bCONTEXT\\b"),
    Terminal(TerminalName::RES_COVER, "COVER", "\\bCOVER\\b"),
    Terminal(TerminalName::RES_DEFAULT, "DEFAULT", "\\bDEFAULT\\b"),
    ...
    Terminal(TerminalName::RES_FAIRNESS, "FAIRNESS", "\\bFAIRNESS\\b"),
    Terminal(TerminalName::RES_FILE, "FILE", "\\bFILE\\b"),
    Terminal(TerminalName::RES_FOR, "FOR", "\\bFOR\\b"),
    Terminal(TerminalName::RES_FORCE, "FORCE", "\\bFORCE\\b"),
    ...
    Terminal(TerminalName::RES_PARAMETER, "PARAMETER", "\\bPARAMETER\\b"),
    ...
    Terminal(TerminalName::RES_PROPERTY, "PROPERTY", "\\bPROPERTY\\b"),
    Terminal(TerminalName::RES_PROTECTED, "PROTECTED", "\\bPROTECTED\\b"),
    ...
    Terminal(TerminalName::RES_RELEASE, "RELEASE", "\\bRELEASE\\b"),
    Terminal(TerminalName::RES_REM, "REM", "\\bREM\\b"),
    Terminal(TerminalName::RES_REPORT, "REPORT", "\\bREPORT\\b"),
    Terminal(TerminalName::RES_RESTRICT, "RESTRICT", "\\bRESTRICT\\b"),
    Terminal(TerminalName::RES_RESTRICT_GUARANTEE, "RESTRICT_GUARANTEE", "\\bRESTRICT_GUARANTEE\\b"),
    ...
    Terminal(TerminalName::RES_SEQUENCE, "SEQUENCE", "\\bSEQUENCE\\b"),
    ...
    Terminal(TerminalName::RES_STRONG, "STRONG", "\\bSTRONG\\b"),
    ...
    Terminal(TerminalName::RES_VMODE, "VMODE", "\\bVMODE\\b"),
    Terminal(TerminalName::RES_VPROP, "VPROP", "\\bVPROP\\b"),
    Terminal(TerminalName::RES_VUNIT, "VUNIT", "\\bVUNIT\\b"),
